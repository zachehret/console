...
public class ConsoleConfiguration {
	 ...
	 */
	public static String CONSOLE_TITLE = "NaN";
	...
	/**
	 * Whether or not the System.out calls will be redirected to the console window
	 * Use with true/false
	 */
	public static boolean CAPTURE_SYS_OUT = false;
	...
	/**
	 * Whether the toolbar at the top is shown. (File, Data, View)
	 */
	public static boolean SHOW_TOOLBAR = true;
	/**
	...
	public static final Version version = new Version(new DateVersionFormat("A17.2019.06.27-09:02:13"));
	
	/** 
	 * CUSTOM FORMATS MAY BE USED BUT MUST FOLLOW STRICT GUIDELINES. ALL CHARACTERS ARE LEGAL AND ONLY THE FOLLOWING WILL BE REPLACED::
	 * 
	 * YYYY = YEAR,
	 * MO = MONTH,
	 * DD = DAY,
	...
	public static void resetCustomColors() {
		MSG_CUSTOM_COLOR = ConsoleConfiguration.TEXT_COLOR;
		BACKGROUND_CUSTOM_COLOR = ConsoleConfiguration.BACKGROUND_COLOR;
	}
